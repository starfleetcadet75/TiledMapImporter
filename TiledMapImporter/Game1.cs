...
namespace TiledMapImporter
{
    ...
    public class Game1 : Game
    {
        ...
        protected override void Draw(GameTime gameTime)
        {
            ...
            // If you wish to specify a background color here rather then in the Tiled Editor,
            // call "map.BackgroundColor = Color.White" before calling Draw.
            // The default color used is White if none is specified.
